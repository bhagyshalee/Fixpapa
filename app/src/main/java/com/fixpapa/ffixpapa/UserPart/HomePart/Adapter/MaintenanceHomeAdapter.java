...
public class MaintenanceHomeAdapter extends RecyclerView.Adapter<MaintenanceHomeAdapter.ViewHolder> {
    private Context context;
    List<Amc> services;
    int loginStatus;

    public MaintenanceHomeAdapter(List<Amc> services, Context context) {
        super();
    ...
    @Override
    public MaintenanceHomeAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.design_home, parent, false);
        MaintenanceHomeAdapter.ViewHolder viewHolder = new MaintenanceHomeAdapter.ViewHolder(view);
        return viewHolder;
    }


    @Override
    public void onBindViewHolder(MaintenanceHomeAdapter.ViewHolder holder, final int position) {

        Amc category = services.get(position);
