...
public class DataDetailInfo {
    ...
    @Expose
    private List<ExpertiseEn> expertise = null;
    @SerializedName("requestjob")
    @Expose
    private List<Object> requestjob = null;
    ...
    public List<ExpertiseEn> getExpertise() {
        return expertise;
    }

    public void setExpertise(List<ExpertiseEn> expertise) {
        this.expertise = expertise;
    }

    public List<Object> getRequestjob() {
        return requestjob;
    }

    public void setRequestjob(List<Object> requestjob) {
